...
\Section*{Décima Oração}{para a Santíssima Mãe de Deus}
...
Ora junto a Deus por mim, ó Santo \dotextit{[nome do Santo]}, Bem-Aventurado de
...
\dotextit{Durante períodos de jejum dizer:}

\Section*{Oração de arrependimento}{de São Efrem, o Sírio}
...
\dotextit{Então a oração inteira de de São Efrem é repetida com uma prostração
no final.}

{\begin{center}\includesvg[height=10pt]{ornaments/byzantine-cross-3}\end{center}}

\dotextit{Ofereça agora uma pequena oração pela saúde e salvação do seu pai
    espiritual, seus pais, familiares, governantes, benfeitores e outros
    conhecidos, dos enfermos, ou daqueles que estão passando por algum
    sofrimento. E, se possível, leia esta comemoração:}
