...
\renewcommand{\chapterlinesformat}[3]{%
    \ifempty{\chapheader}%
        {\includesvg[height=20pt]{ornaments/byzantine-cross-3}\break{}}%
        \else {\includesvg[width=\textwidth]{\the\chapheader}\break{}}\fi
    \normalfont\Huge\centering{\uppercase{#3}}}
\newcommand{\Chapter}[3][]{%
    \chapheader{#1}
    \chapter[#2 #3]{#2}\vspace*{-\parskip}{\centering\textit{\Large{#3}}\par}}
