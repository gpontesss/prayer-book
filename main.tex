...
% TODO: fonts are the problem with page style. it seems to have something to do
% with square brackets? https://tex.stackexchange.com/questions/447849/xelatex-exhibiting-strange-behaviour-surrounding-new-pages-and-text-shapes
% \newfontfamily{\garamondfont}[
...
% \setkomafont{disposition}{\garamondfont}
...
\renewcommand{\sectionlinesformat}[4]{%
    \small\centering{\dotext{\textbf{\uppercase{#4}}}}\vspace*{-\parskip}}
\WithSuffix\newcommand\Section*[2]{%
    \dotext{\section*{#1}\vspace*{-\parskip}{\small\centering\textit{#2}\par}}}
...
\renewcommand{\chapterlinesformat}[3]{%
    ...
    \Huge\centering{\textbf{\uppercase{#3}}}}
